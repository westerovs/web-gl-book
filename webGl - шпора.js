...
// --------------------- объявление переменной-атрибута см 66стр
...
// Что бы передать данные в переменную a_Position находящ. внутри шейдера, необх. запросить у системы WebGl 
// местоположение этой переменной, вызвав метод getAttributeLocation
